#ifndef CGRAPHICVIEWANIMATIONINDEXLISTITEM_H
#define CGRAPHICVIEWANIMATIONINDEXLISTITEM_H
#include "cspgraphicviewanimationindexitem.h"

class GRAPHICVIEW_EXPORT CSpGraphicViewAnimationIndexListItem:public CSpGraphicViewAnimationIndexItem
{
    Q_OBJECT
public:
    CSpGraphicViewAnimationIndexListItem(CSpGraphicViewItem* pFatherItem = nullptr);
...
#endif // CGRAPHICVIEWANIMATIONINDEXLISTITEM_H
